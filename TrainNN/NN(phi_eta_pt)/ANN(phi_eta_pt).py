...
X_pos = df_pos[['Phi_PiPlus', 'Phi_PiMinus', 'Eta_PiPlus', 'Eta_PiMinus', 'Pt_PiPlus_log', 'Pt_PiMinus_log']].values
X_neg = df_neg[['Phi_PiPlus', 'Phi_PiMinus', 'Eta_PiPlus', 'Eta_PiMinus', 'Pt_PiPlus_log', 'Pt_PiMinus_log']].values
...
X_pos = X_pos
X_neg = X_neg
names = ['Phi_PiPlus', 'Phi_PiMinus', 'Eta_PiPlus', 'Eta_PiMinus', 'Pt_PiPlus_log', 'Pt_PiMinus_log']
