...
X_pos = df_pos[['Phi_PiPlus', 'Phi_PiMinus', 'Eta_PiPlus', 'Eta_PiMinus', 'Pt_PiPlus_log', 'Pt_PiMinus_log', 'ipX_PiPlus', 'ipY_PiPlus', 'ipZ_PiPlus', 'ipX_PiMinus', 'ipY_PiMinus', 'ipZ_PiMinus', 'Vis_DiTau_Mass']].values
X_neg = df_neg[['Phi_PiPlus', 'Phi_PiMinus', 'Eta_PiPlus', 'Eta_PiMinus', 'Pt_PiPlus_log', 'Pt_PiMinus_log', 'ipX_PiPlus', 'ipY_PiPlus', 'ipZ_PiPlus', 'ipX_PiMinus', 'ipY_PiMinus', 'ipZ_PiMinus', 'Vis_DiTau_Mass']].values
...
X_pos = X_pos
X_neg = X_neg
names = ['Phi_PiPlus', 'Phi_PiMinus', 'Eta_PiPlus', 'Eta_PiMinus', 'Pt_PiPlus_log', 'Pt_PiMinus_log', 'ipX_PiPlus', 'ipY_PiPlus', 'ipZ_PiPlus', 'ipX_PiMinus', 'ipY_PiMinus', 'ipZ_PiMinus', 'Vis_DiTau_Mass']
...
plt.legend([f'CP-mix ($\\phi$ = 45°)', 'CP-mix ($\\phi$ = -45°)']) #'Bkgd/20'])
...
#plt.hist(df_bkgd['SignedAcoplanarity'],weights=w_bkgd/20,histtype='step',bins=28, range=(-1*np.pi,np.pi))
#add axis labels to this plot
plt.xlabel('$\\varphi^*_{CP}$')
plt.ylabel('Weights (arbitrary units)')
#add legend to this plot
plt.legend(['CP-mix ($\\phi$ = 45°)','CP-mix ($\\phi$ = -45°)']) #'Bkgd/20'])
